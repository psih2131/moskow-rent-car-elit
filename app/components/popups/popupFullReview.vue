<template>
    ...
    <Transition name="slide-fade">
        <div v-if="show" class="popup-done popup-review popup">
            ...
            <div class="popup-done__wrapper">
                <div class="header-row-sec-v2">            
                    <h2 class="home-our-client-sec__title sec-title sec-title--center-mod"><b v-html="store.reviewTextPopup.title"></b></h2>
                </div>
                <p class="contacts-sec__form-subtitle" v-html="store.reviewTextPopup.text"></p>
            </div>
...
function closePopup(){
    ...
    setTimeout(()=>{
        ...
        store.changeReviewTextPopup(null)
    },800)
