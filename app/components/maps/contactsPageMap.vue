<template>
    ...
    >
        ...
        <yandex-map-marker
          ...
          :settings="{ coordinates: [mapData.karta_dolgota,mapData.karta_shirota] }"
        >
            <div class="y-map__marker-wrapper">
                <img
                  v-if="mapData.ikonka_karty?.url"
                  :src="mapData.ikonka_karty.url"
...
const props = defineProps({
     mapData: {
        ...
        default: () => ({}) // если не обязательно, можно задать дефолт
    }
})
...
const clusterer = ref<any>(null)
    ...
    const customization = shallowRef<any[]>([
    {
        "tags": "country",
