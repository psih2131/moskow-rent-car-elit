...
useHead({
    ...
    meta: [
        ...
        { property: 'og:image', content: currentPartnershipData.value?.[0]?.acf?.og_image?.url || store.defaultUrlOgImage },
        ...
        { name: 'twitter:image', content: currentPartnershipData.value?.[0]?.acf?.og_image?.url || store.defaultUrlOgImage },
