...
useHead({
    ...
    meta: [
        ...
        { property: 'og:image', content: currentDocsData.value?.[0]?.acf?.og_image?.url || store.defaultUrlOgImage },
        ...
        { name: 'twitter:image', content: currentDocsData.value?.[0]?.acf?.og_image?.url || store.defaultUrlOgImage },
