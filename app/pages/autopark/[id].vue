<template>
  ...
  <div id="scroll-container"  >
    ...
    <div class="car-page-price-char-wraper">
      ...
      <section class="car-price-sec" v-if="currentCarData[0].acf.zagolovok_stoimost_arendy">
        <div class="container">
          <div class="header-row-sec">
            ...
            <div class="price-table-pc-ipad-wrapper">
            ...
            <div class="price-table-mob-wrapper" >
              ...
              <div class="price-car-swiper__wrapper">

              
              <template v-if="switchPrice == 1 ">
                
                <priceSecMobCar v-if="loadClient == true" :dataSlider="currentCarData[0].acf.gibkaya_stoimost_arendy" />
    
              </template>

              <template v-else-if="switchPrice == 2">

                <priceSecMobCar v-if="loadClient == true" :dataSlider="currentCarData[0].acf.stoimost_arendy_pomesyachno" />
  ...
  <!-- 
    ...
    <section class="clients-about-us" v-if="currentCarData[0].acf.zagolovok_otzyvy_klientov && currentCarData[0].acf?.otzyvy_klientov?.otzyvy?.length > 0">
        <div class="container">
          ...
          <reviewSlider :sliderData="currentCarData[0].acf.otzyvy_klientov.otzyvy" />
